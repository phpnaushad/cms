                      ...
                      <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                        <thead>
                          <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Banner Desp</th>
                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Banner Image</th>
                        ...
                        <tbody>
                         @foreach($banners as $banner)
                          <tr>
                              ...
                              <td><a href="{{ route('banner.edit', $banner->id) }}">
                                <i class="fas fa-edit fa-lg"></i></a>
                              </td>      
                              <td>
								<form action="{{ route('banner.destroy', $banner->id) }}" onsubmit="return confirm('Are you sure?');"  method="post">
                                  @csrf
                                  @method('DELETE')               
